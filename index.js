...
client.connect(PORT, HOST, function() {
    ...
    let session = manus.open({
        ...
        onDeviceInfo: function(eventID, buf) {
            ...
            16    apollo_laterality_t hand;(side) /// info on whether this device is a left or a right glove
           ...
           */
            ...
            let side = new DataView(buf, 16).getInt32(0, true)
            ...
            console.log(`NODE: onDeviceInfo event=${eventID}, deviceID=${deviceID} dongleID=${pairedDongleID}, hand=${side}, deviceType=${devType}, bat%=${batteryPercent}, signal=${signalAttenuationDb}`)        
